...
import 'package:gohomy/screen/admin/report/user_did_kyc/widget/chart_user_did_kyc.dart';
...
class ReportUserDidKycScreen extends StatelessWidget {
  DateTime? fromDate;
  DateTime? toDate;

  ReportUserDidKycScreen({
    this.fromDate,
    this.toDate,
  }) {
    controller = Get.put(ReportUserDidKycController(
  ...
  late ReportUserDidKycController controller;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Thống kê người dùng đã KYC'),
      ),
      body: SmartRefresher(
        enablePullDown: true,
        enablePullUp: false,
      ...
      child: Padding(
          ...
          child: Obx(
            () => !SahaDateUtils()
                    ...
                    .isAtSameMomentAs(
                        SahaDateUtils().getDate(controller.toDay.value))
                ? Row(
                    children: [
                      Icon(
                        Icons.access_time,
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(SahaDateUtils()
                                  .getDDMMYY(controller.toDay.value)),
                            ],
                          ),
                        ],
                      ),
